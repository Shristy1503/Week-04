package commonproblems.implementashoppingcart;
import java.util.*;

public class ImplementShoppingCart {
    private static Map<String, Double> productPrices = new HashMap<>(); // Stores product prices (unordered)
    private static Map<String, Double> cartOrder = new LinkedHashMap<>(); // Maintains insertion order
    private static TreeMap<Double, String> sortedCart = new TreeMap<>(); // Sorts by price
