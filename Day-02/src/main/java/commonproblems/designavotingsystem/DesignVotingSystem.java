package commonproblems.designavotingsystem;
import java.util.*;

public class DesignVotingSystem {
    private static Map<String, Integer> voteMap = new HashMap<>(); //create hash map
    private static Map<String, Integer> voteOrderMap = new LinkedHashMap<>(); //create linked hash map
    private static TreeMap<String, Integer> sortedVoteMap = new TreeMap<>(); //create tree map
    ...
    public static short displaySortedVotes() {
    ...
    public static void displayAllVotes() {
